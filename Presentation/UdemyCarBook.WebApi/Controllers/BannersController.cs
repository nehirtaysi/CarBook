...
using UdemyCarBook.Application.Features.CROS.Queries.BannerQueries;
...
namespace UdemyCarBook.WebApi.Controllers
{
    ...
    public class BannersController : ControllerBase
    {
        ...
        public BannersController(GetBannerQueryHandler getBannerQueryHandler,
            GetBannerByIdQueryHandler getBannerBuIdQueryHandler,
            ...
            RemoveBannerCommandHandler removeBannerCommandHandler)
        {
            ...
            _getBannerByIdQueryHandler = getBannerBuIdQueryHandler;
